...
import { ChevronDown, ChevronRight, Mic, BarChart3, Send, Sparkles, Image, Lightbulb, MessageCircle, Users, Headphones, Briefcase, RefreshCw, Phone, Video, CalendarDays, User, Check, Mail } from 'lucide-react';
import { ScrollReveal, Section, SectionHeader, Button, GridPattern, VitruvianBackground, Surface, PageHero, Eyebrow } from './Shared';
...
export const PulseHeroDiagram: React.FC = () => {
...
export const MeetingAnalyzerAnimation: React.FC = () => {
...
export const IdeaToContentAnimation: React.FC = () => {
...
export const ScheduleAnimation: React.FC = () => {
