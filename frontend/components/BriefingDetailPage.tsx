...
const briefings: Record<string, BriefingData> = {
   ...
   "local-llm-stack": {
      id: "local-llm-stack",
      title: "Local LLM Stack: Private Inference for Legal Ops",
...
const BriefingDetailPage: React.FC<BriefingDetailPageProps> = (props) => {
   ...
   const data = (props.id && briefings[props.id]) ? briefings[props.id] : briefings["agentic-workflow"];
         ...
         <Section pattern="nodes" overflow={true} className="bg-white/50">
            ...
            <article className="lg:col-span-9 max-w-3xl mx-auto">
               ...
               {data.furtherResources && data.furtherResources.length > 0 && (
                  <div id="further-reading" className="bg-ink text-canvas p-8 rounded-sm">
